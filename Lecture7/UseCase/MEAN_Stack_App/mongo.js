...
var url='mongodb://snehadidigam:mlab1995@ds155278.mlab.com:55278/databasenode';//1.Modify this url with the credentials of your db name and password.
...
//     db.collection('books').update( data, function(err, result) {
//         if(err)
//         {
//             res.write("Registration Failed, Error While Registering");
//             res.end();
